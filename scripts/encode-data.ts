...
const FILES = ['rooms.json', 'items.json', 'story.json', 'puzzles.json', 'scenery.json', 'ship-systems.json', 'rejected-verbs.json', 'messages.json', 'prompts.json', 'state-transitions.json', 'rules.json'];
